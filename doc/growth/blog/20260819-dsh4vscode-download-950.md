# DSH4VS Code 文案（950+ × v0.1.0）

**日期**: 2026-08-19 ｜ **平台**: 小红书 ｜ **状态**: 待发布
...
0.1.0 更新：
📁 工作区自动对齐：切文件夹关旧面板、冷启动；重载同一工作区自动重启并恢复；UI 显示当前工作区
⚡ 点图标自动启动 dsh
🚀 版本软校验：提示新版，按安装方式推荐升级命令（终端预填不自动执行，24h 一次）
✨ 侧边栏精炼 + 9 语言
...
#DeepSeek #DeepSeekHarness #DSH #AI编程 #效率工具 #VS Code #Antigravity #开源
