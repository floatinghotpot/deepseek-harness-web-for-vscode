...
|---|---|
| `0.3.6`（当前） | `0.1.2-rc.1`、`0.1.5-rc.1`、`0.1.5-rc.2`、`0.1.7-rc.1` |
| `0.3.4` – `0.3.5` | `0.1.2-rc.1`、`0.1.5-rc.1`、`0.1.5-rc.2`（`0.1.7` 请用 `0.3.6`；`0.3.4` 另有设置页问题，`0.3.5` 已修） |
| `0.3.3` | `0.1.1-rc.7` 及更早 |

- 表中为**实测通过**的搭配。dsh `0.1.2-rc.1` 起更换了 Web 表面（浏览器会话认证、Typert RPC、新 dist 布局），扩展 `≤ 0.3.3` 无法使用它；扩展 `0.3.4` 又要求 dsh `≥ 0.1.2-rc.1`（更旧会在启动时提示升级），因此旧 dsh 需搭配 `0.3.3`。
