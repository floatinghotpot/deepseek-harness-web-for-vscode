...
|---|---|
| `0.3.6` (current) | `0.1.2-rc.1`, `0.1.5-rc.1`, `0.1.5-rc.2`, `0.1.7-rc.1` |
| `0.3.4` – `0.3.5` | `0.1.2-rc.1`, `0.1.5-rc.1`, `0.1.5-rc.2` (use `0.3.6` for `0.1.7`; `0.3.4` also has the Settings-page bug fixed in `0.3.5`) |
